# DeksdenFlow_Ilyas_Edition_1.0 Overview

DeksdenFlow_Ilyas_Edition_1.0 is an agent-first workflow tuned for doing changes in parallel streams with clear contracts. The public series (7 posts) covers:
